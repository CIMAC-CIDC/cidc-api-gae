...
details_dict = {
    ...
    "/ihc/ihc_image.": FileDetails(
        ...
        "An image file generated from an IHC experiment. Generally, higher signal relates to higher local concentrations of protein, allowing for inferences of both tissue- and cell-level localization.",
    ),
