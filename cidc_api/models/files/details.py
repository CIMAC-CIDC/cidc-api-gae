...
details_dict = {
    ...
    "/cytof/spike_in.fcs": FileDetails(
        "source", "normalized and debarcoded fcs data for a blank spike-in sample", ""
    ),
    ...
    "/cytof/normalized_and_debarcoded.fcs": FileDetails(
        "source", "normalized and debarcoded fcs data, without cleaning", ""
    ),
    ...
    "/wes/r1_.fastq.gz": FileDetails(
        ...
        "A gzipped, FASTQ file that represents the 5' read of paired sequencing. Generated by the sequencing machine defined by the RNA assay this file is associated with.",
    ),
    "/wes/r2_.fastq.gz": FileDetails(
        "source",
        "fastq file of raw Read 2, compressed",
        "A gzipped, FASTQ file that represents the 3' read of paired sequencing. Generated by the sequencing machine defined by the RNA assay this file is associated with.",
    ),
    ...
    "/wes/analysis/clonality_pyclone.tsv": FileDetails(
        "miscellaneous",
        "tab-separated input file for PyClone generated by Sequenza",
        "",
    ),
    "/wes/analysis/copynumber_cnvcalls.txt": FileDetails(
        "miscellaneous", "plain-text copynumber analysis results, from Sentieon CNV", ""
    ),
    ...
    "/mif/roi_/composite_image.tif": FileDetails(
        ...
        "A TIFF image of the region-of-interest that contains the composition of all components into a combined image. Exported from inForm (PerkinElmer).",
    ),
    ...
    "/olink/chip_/assay_raw_ct.csv": FileDetails(
        ...
        "A comma-separated, plain-text table that contains the raw Ct value results from a single chip. These values are not normalized for intra- or inter-assay variablity, and a high Ct value is related to a low protein concentration.",
    ),
    # IHC
    "/ihc/ihc_image.": FileDetails(
        "source",
        "image file that is the result of an IHC experiment",
        "An image file generated from an IHC experiment. Generally, higher signal relates of higher local concentrations of protein, allowing for inferences of both tissue- and cell-level localization.",
    ),
